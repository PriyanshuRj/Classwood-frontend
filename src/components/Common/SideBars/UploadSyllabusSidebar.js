...
import {
  addNewClassSubjectsBookChapter,
  addAWholeBookChapter,
  removeClassSubjects,
} from "../../../store/School/syllabusSlice";
export default function UploadSyllabusSidebar({ setOpenUpload }) {
  const dispatch = useDispatch();
  const [book, setSubjectBook] = useState("");
          ...
          <div className="flex flex-col mx-8 mt-8 justify-between flex-1">
            <div className="flex flex-col h-full">
              ...
              <div className="flex flex-col max-w-2xl mt-4">
                <label className="font-medium text-sm mt-2 text-gray-600">
                  Subject Book*
                </label>
                <input
                  type="text"
              ...
              {subjectChapters.map((subject, index) => {
        return (
            ...
            <div className="flex flex-row w-full">
              ...
              <div className="flex flex-row justify-between w-full items-center">
                ...
                <input
                  value={subject.name}
                  type="text"
                  onChange={(e) => setChapterName(e.target.value, index)}
                  placeholder="Subject"
...
{/* 
            ...
            <button
              ...
              className="mb-8 self-end w-full py-2 mt-8 font-semibold text-white bg-indigo-500 rounded-md text-md "
            >
              Submit
            </button>
          </div>
