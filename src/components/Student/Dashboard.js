    ...
    <div className="w-full">
      <div className="flex items-center justify-between w-full p-10 py-6 bg-white  border-b-[0.5px] border-[#D9D9D9]">
        ...
        <div className="flex flex-row items-center justify-center">
          <button
            className="px-8 py-4 text-lg text-white rounded-full text-medium"
            style={{
          ...
          <div className="p-4 ml-4 bg-[#F6F8FE] rounded-full">
            <svg
              width="24"
              height="24"
              viewBox="0 0 24 24"
          ...
          <div className="p-4 ml-4 bg-[#D9D9D9] rounded-full">
            <svg
              width="24"
              height="24"
              viewBox="0 0 24 24"
          ...
          <div className="mx-4 mt-10 md:mx-0">
            ...
            <div className="flex justify-between mt-8">
              <div className="flex flex-col p-4 bg-white rounded-xl border-[1px] border-[#D9D9D9] w-56 min-[1200px]:w-40 xl:w-56 min-[1700px]:w-64 mr-4">
                ...
                <p className="text-2xl text-[#5F6368] fond-medium mt-2">Physics</p>
                <p className="text-lg text-[#5F6368] flex flex-row items-center">
              ...
              <div className="hidden min-[600px]:flex flex-col p-4 bg-white rounded-xl border-[1px] border-[#D9D9D9] w-56 min-[1200px]:w-40 xl:w-56 min-[1700px]:w-64 mr-4">
                ...
                <p className="text-2xl text-[#5F6368] fond-medium mt-2">Chemistery</p>
                <p className="text-lg text-[#5F6368] flex flex-row items-center">
                  View Subjets <MdNavigateNext />
                </p>
              </div>
              <div className="hidden min-[400px]:flex flex-col p-4 bg-white rounded-xl border-[1px] border-[#D9D9D9] w-56 min-[1200px]:w-40 xl:w-56 min-[1700px]:w-64 ">
                ...
                <p className="text-2xl text-[#5F6368] fond-medium mt-2">Maths</p>
                <p className="text-lg text-[#5F6368] flex flex-row items-center">
            ...
            <div className="md:rounded-[30px] bg-white text-black p-4 md:p-6 w-full  py-10 h-max">
              <a href="/">
                <div className="flex justify-center p-4 ">
                    <span className="text-sm text-right bg-[#61C26B] rounded-full self-start w-16 h-16 mr-4 flex justify-center items-center text-white">11<br/> jan</span>
