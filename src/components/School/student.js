  ...
  return (
    <Layout>
      <div className="px-0 md:px-10">
        ...
        <p className="text-xl font-semibold ">CLass {localStorage.getItem("className")} Student</p> : <p className="text-xl font-semibold">All Students</p>
      }
       ...
       <div className="flex flex-row my-8">
        ...
        {students.length!==0 ?  <div className="grid gap-4 min-[590px]:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4">
        ...
        </div> : <div className="flex items-center justify-center w-full h-96">
          <p>
            No students In Class Right Now
          </p>
           </div>}
      </div>
    </Layout>
