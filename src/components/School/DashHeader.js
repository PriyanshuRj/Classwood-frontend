...
export default function DashHeader() {
  return (
    <div className="flex items-center justify-between w-full p-10 py-6 bg-white  border-b-[0.5px] border-[#D9D9D9]">
      <p className="text-2xl font-semibold sm:text-4xl">Hello School !</p>
      <div className="flex flex-row items-center justify-center">
        ...
        < BiNotification className="text-blue-600 h-8 w-8 min-[480px]:h-6 min-[480px]:w-6 sm:w-4 sm:h-4 md:w-10 md:h-10 text-[#5F6368]" />
